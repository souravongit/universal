...
tinyMCE.init({
    ...
    $query= "SELECT * FROM manage_product WHERE id='$product_id'";
    ...
    <div class="field">
	<form action="actions.php?action=editproduct" method="post" enctype="multipart/form-data" onSubmit="return check_form(); ">      
    ...
    <label>Product Name <span class="red">*</span></label> <div><input  type="text" name="product_name" id="product_name" class="text-input" value="<?php echo $row["product_title"];?>" /><label style="float:right" class="error" for="product_name" id="product_name_error">Product Name is required.</label></div>
	
	<label>Product Type <span class="red">*</span></label> <div><select name="product_type" id="product_type">
	 															<option value="" >Select...</option>
																<option value="universal_sales" <?php if($row["product_type"]=="universal_sales") { echo "selected";} ?>>Universal Sales</option>
																<option value="universal_energy_solutions" <?php if($row["product_type"]=="universal_energy_solutions") { echo "selected";} ?>>Universal Energy Solutions(P)Ltd</option>
																<option value="universal_sales_projects" <?php if($row["product_type"]=="universal_sales_projects") { echo "selected";} ?>>Universal Sales Projects</option>
	 															 </select><label style="float:right" class="error" for="product_type" id="product_type_error">Product Type is required.</label></div>
	
	 <label>Product Details <span class="red">*</span></label> <div><textarea name="product_details" id="product_details" rows="6" cols="50"><?php echo $row["product_details"];?></textarea><label style="float:right" class="error" for="product_details" id="product_details_error">Product Details is required.</label></div>
   ...
   <div id="submit" style="left:20px;"><input type="submit" name="submit" id="submit" value="submit" /></div>
	...
	<div align="center">
	<label  class="error" for="product_added" id="product_added">Product Successfully Updated.</label><label  class="error" for="product_added_error" id="product_added_error">Product Cant Added.</label></div>
	 <hr class="space" />
	 </form>
    </div>
	<div class="progress" >
